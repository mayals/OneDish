const ContactUs = ()=>{
    return(
        ...
        <section className="text-gray-600 body-font bg-yellow-100 mt-0 md:mt-0">
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-900 to-orange-200 mb-0 text-center py-8 mt-2">نسعد بتواصلك</h2>

            <div id="contact-form" className="container flex flex-col md:flex-row lg:max-w-5xl w-full px-5 py-12 md:py-24 mx-auto section">
