...
const AdminUserListPage = () => {
  ...
  const filteredUsers = Array.isArray(users) ? users.filter(user => 
    ...
    const roleOptions= ["All User, Admin, Client"]
      ...
      <div className="flex flex-col">
        <div className="overflow-x-auto">
          <div className="min-w-full inline-block align-middle">
            ...
            {/* role filter  */}
            <div className="overflow-y-scroll h-96"> {/* Fixed height for scrolling */}
                {/* Filter role */}
                <h6 className="ml-4 text-base font-medium text-black my-2">
                    Roles
                </h6> 
                <ul className="text-sm text-gray-700" aria-labelledby="dropdownSearchButton">
                            ...
                            <li key={index}>
                                <div className="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input
                                        ...
                                        className="w-4 h-4 text-[#9933ff] focus:ring-[#9933ff] bg-gray-100 border-gray-300"
                                    />
                                    <div className="ms-2 text-sm">
                                        <label htmlFor={`radio-item-${index}`} className="font-medium text-gray-900 dark:text-gray-300">
                                            <div>{item}</div>
                                        </label>
                                    </div>
                                </div>
